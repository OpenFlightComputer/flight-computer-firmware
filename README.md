...
Phase 1, Milestone 1.4 adds a hardware-independent ordinary DShot frame encoder.
Separate public paths keep stop/throttle values away from reserved ESC commands,
and exhaustive host tests cover every 11-bit value with both telemetry states.
It does not yet convert normalized motor commands, select a rate, configure
TIM8/GPIO/DMA, or produce a physical motor output.
