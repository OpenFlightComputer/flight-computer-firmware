                        ...
                        uint32_t events)
{
    ...
    *record = (control_trace_record_t){
        ...
        .takeoff_leveling_state = sample->takeoff_leveling_state,
        .level_calibration_state = sample->level_calibration_state,
        .receiver = {
        ...
        .effective_attitude_target = {
            sample->effective_attitude_target_degrees[0],
            sample->effective_attitude_target_degrees[1],
        },
        .motor_baseline = sample->motor_baseline,
