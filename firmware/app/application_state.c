...
volatile uint32_t firmware_rate_controller_result =
...
level_calibration_t firmware_level_calibration;
imu_processing_pipeline_t firmware_imu_processing_pipeline;
control_trace_t firmware_control_trace;
blackbox_t firmware_blackbox;
flight_control_core_t firmware_flight_control_core;
manual_easy_behavior_t firmware_manual_easy_behavior;
