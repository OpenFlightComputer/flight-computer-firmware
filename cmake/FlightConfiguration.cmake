...
if(NOT OFC_CONFIG_SCHEMA_VERSION EQUAL 11)
    message(FATAL_ERROR "Default configuration schema_version must be 11")
endif()
ofc_json_get(flight_behavior behavior name)
if(flight_behavior STREQUAL "manual_easy")
    set(OFC_CONFIG_FLIGHT_BEHAVIOR "FLIGHT_BEHAVIOR_MANUAL_EASY")
else()
    message(FATAL_ERROR "Invalid default flight behavior: ${flight_behavior}")
endif()
string(JSON behavior_settings_length LENGTH
    "${OFC_DEFAULT_CONFIGURATION_JSON}" behavior settings)
if(NOT behavior_settings_length EQUAL 0)
    message(FATAL_ERROR "Manual Easy behavior settings must currently be empty")
endif()
