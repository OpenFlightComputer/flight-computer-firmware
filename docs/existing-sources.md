...
### Working USB implementation reused by Milestones 0.10 and 0.11
...
| Static CDC transport queues | `firmware/manufacturing_test/protocol/usb_cdc_transport.c` | Reused for two-entry transmit and receive-line queues plus a 512-byte ISR-to-main ring, with flight-specific bounds |
| Newline framing | `firmware/manufacturing_test/protocol/newline_framer.c` | Closely adapted for bounded LF/CRLF framing and discard-through-newline recovery |
