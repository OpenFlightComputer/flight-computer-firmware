...
| `bootloader_enter` | While safely disarmed, stop motor output and perform a one-shot reset into the resident USB update loader |
...
write envelope contains the complete schema-10 object from
...
{"type":"response","request_id":44,"command":"receiver","ok":true,"available":true,"sequence":7,"age_us":1250,"freshness":"FRESH","channels":[174,175,176,177,178,179,180,181,182,183,184,185,186,187,188,189],"normalized":{"roll":-0.500000,"pitch":0.250000,"yaw":0.000000,"throttle":1.000000,"arm":true},"failsafe":{"state":"LIVE","action":"LIVE","stage_two_latched":false,"recovery_ready":false},"link_statistics_present":true,"uplink_rssi_dbm":-42,"uplink_link_quality_percent":99,"uplink_snr_db":8,"uart_bytes":135014,"valid_frames":5000,"uart_last_error":12,"uart_errors":1,"uart_recoveries":1,"uart_recovery_failures":0,"uart_recovery_pending":false,"crc_errors":0,"framing_errors":0,"dma_overruns":0,"dma_bytes_dropped":0}
